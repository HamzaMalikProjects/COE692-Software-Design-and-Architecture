...
<body>
    ...
    <div id="confirmationModal">
        <div class="modal-content">
            ...
            <div class="cancel-button-container">
                ...
                <button id="confirmCancellation" class="confirm-button">Yes, Cancel</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // Script to confirm cancellation
        document.getElementById('confirmCancellation').addEventListener('click', function() {
            // TODO: Implement cancellation logic, e.g., AJAX request to server
            alert('Booking cancelled successfully.'); // Placeholder functionality
            document.getElementById('confirmationModal').style.display = 'none';
            // Reset the form
